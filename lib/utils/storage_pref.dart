...
abstract final class Pref {
  ...
  static bool get manualLoadCommentImage =>
      _setting.get(SettingBoxKey.manualLoadCommentImage, defaultValue: false);
  ...
  // ===== AI 图片识别 (AI Image Moderation) =====

  static bool get enableAiImageModeration =>
      _setting.get(SettingBoxKey.enableAiImageModeration, defaultValue: false);
  static set enableAiImageModeration(bool value) =>
      _setting.put(SettingBoxKey.enableAiImageModeration, value);

  static String get aiModelRepoUrl =>
      _setting.get(SettingBoxKey.aiModelRepoUrl, defaultValue: '');
  static set aiModelRepoUrl(String value) =>
      _setting.put(SettingBoxKey.aiModelRepoUrl, value);

  static bool get aiModelDownloaded =>
      _setting.get(SettingBoxKey.aiModelDownloaded, defaultValue: false);
  static set aiModelDownloaded(bool value) =>
      _setting.put(SettingBoxKey.aiModelDownloaded, value);

  static String get aiModelFormat =>
      _setting.get(SettingBoxKey.aiModelFormat, defaultValue: '');
  static set aiModelFormat(String value) =>
      _setting.put(SettingBoxKey.aiModelFormat, value);

  static int get aiModelInputSize =>
      _setting.get(SettingBoxKey.aiModelInputSize, defaultValue: 224);
  ...
  static bool get aiAutoBlocklist =>
      _setting.get(SettingBoxKey.aiAutoBlocklist, defaultValue: true);
  static set aiAutoBlocklist(bool value) =>
      _setting.put(SettingBoxKey.aiAutoBlocklist, value);
}
